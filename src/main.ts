...
function loadScene() {
  ...
  splashTex1 = new Texture('./src/textures/splash1.png', 0);
  splashTex2 = new Texture('./src/textures/splash2.png', 0);
  testTex2 = new Texture('./src/textures/rain2.png', 1);
  cobbleTex = new Texture('./src/textures/rain2.png', 2);
}
